...
<!-- Extractlet -->
<!-- GitHub - xtermjs/xterm.js: A terminal for the web · GitHub -->
...
[783c4a3](https://github.com/xtermjs/xterm.js/commit/783c4a34d296480f29ecddfb8743e4e542e29cf5) · 2026-03-09 (22 hours ago)

## History

[10,810 Commits](https://github.com/xtermjs/xterm.js/commits/master/)

## Folders and files

- `.devcontainer/` (Upgrade missed parts from node 18 -> 22; 2025-12-24 (3 months ago))
- `.github/` (Add hook to setup repo when agent starts; 2026-02-13 (25 days ago))
- `.vscode/` (Clean up root, remove auto approve settings; 2026-01-04 (2 months ago))
- `addons/` (Make code more readable; 2026-03-08 (2 days ago))
- `bin/` (Add hook to setup repo when agent starts; 2026-02-13 (25 days ago))
- `css/` (Make arrows a little less fat; 2026-02-03 (last month))
- `demo/` (Revert formatting to demo/client/tsconfig.json; 2026-02-16 (22 days ago))
- `fixtures/escape_sequence_files/` (xterm testfiles for SL/SR/DECIC/DECDC with DECSTBM; 2019-10-24 (6 years ago))
- `headless/` (Fix npm link to deprecated xterm package to @xterm/xterm; 2026-03-05 (5 days ago))
- `images/` (Update readme 2; 2026-01-04 (2 months ago))
- `src/` (Merge pull request #5747 from anthonykim1/anthonykim1/fixIMEoverFlowing; 2026-03-09 (22 hours ago))
- `test/` (Migrate to tsgo; 2026-02-13 (25 days ago))
- `typings/` (Remove internal details about underline cell APIs; 2026-02-07 (last month))
- `.editorconfig` (Remove line ending editorconfig file; 2025-12-24 (3 months ago))
- `.gitattributes` (Fix up.; 2017-06-27 (9 years ago))
- `.gitignore` (Ensure types are checked in demo, fix errors, emit to out-demo; 2025-12-27 (2 months ago))
- `.gitmodules` (Use zmodem.js from npm rather than a git submodule.; 2017-10-16 (8 years ago))
- `.npmignore` (Esbuild package headless; 2024-07-07 (2 years ago))
- `.nvmrc` (Upgrade missed parts from node 18 -> 22; 2025-12-24 (3 months ago))
- `CODE_OF_CONDUCT.md` (Add a code of conduct; 2018-06-07 (8 years ago))
- `CONTRIBUTING.md` (Rework contributing doc; 2025-12-30 (2 months ago))
- `LICENSE` (Revert "Noch mehr änderungen"; 2021-03-25 (5 years ago))
- `README.md` (Clean up note about cjs; 2026-03-09 (22 hours ago))
- `eslint.config.mjs` (Remove vs/, fix lint and build; 2026-02-02 (last month))
- `eslint.config.typings.mjs` (Fix lint-api; 2025-12-24 (3 months ago))
- `package-lock.json` (Merge pull request #5700 from xtermjs/dependabot/npm_and_yarn/qs-6.14.2; 2026-03-08 (2 days ago))
- `package.json` (Fix hook npm script; 2026-02-13 (25 days ago))
- `tsconfig.all.json` (Merge remote-tracking branch 'upstream/master' into pr/jerch/5178; 2026-01-03 (2 months ago))
- `webpack.config.headless.js` (Move to npm; 2025-11-23 (4 months ago))
- `webpack.config.js` (Move to npm; 2025-11-23 (4 months ago))
...
# [![xterm.js](https://github.com/xtermjs/xterm.js/raw/master/images/logo-full.png)](https://xtermjs.org/)
...
- **Performant**: Xterm.js is _really_ fast and includes an optional GPU-accelerated renderer.
...
Since xterm.js is typically implemented as a developer tool, generally only modern evergreen browsers are supported officially. Specifically the latest versions of _Chrome_, _Edge_, _Firefox_, and _Safari_. Xterm.js also works seamlessly in [Electron](https://electronjs.org/) apps and may even work on earlier versions of the browsers. These are the versions we strive to keep working.
...
Some APIs may be marked with _experimental_, these are added to enable experimentation with new ideas without committing to support it like a normal [semver](https://semver.org/) API. Note that these APIs can change radically between versions, so be sure to read release notes if you plan on using experimental APIs.
...
- [**ucli**](https://github.com/tsadarsh/ucli): Command Line for everyone 👨‍👩‍👧‍👦 at [www.ucli.tech](https://www.ucli.tech/).
...
- [And much more...](https://github.com/xtermjs/xterm.js/network/dependents?package_id=UGFja2FnZS0xNjYzMjc4OQ==)
